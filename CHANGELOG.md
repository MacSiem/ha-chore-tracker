...
All notable changes to **Chore Tracker** are documented here.
...
- Persistence keys migrated to per-tool namespace `ha-chore-tracker-…` (clean break — old data under `ha-tools-…` is **not** migrated automatically).
